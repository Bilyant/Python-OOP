...
class Gym:
    ...
    def subscription_info(self, subscription_id: int):
        ...
        equipment = [e for e in self.equipments if e.id == plan.equipment_id][0]
        all_entities = [subscription, customer, trainer, equipment, plan]
        result = [repr(el) for el in all_entities]
        return '\n'.join(result)
